...
class MemberServiceTest {
     ...
     */
    @DisplayName("로그 트랜잭션을 남기는데 실패하더라도, 멤버 트랜잭션은 유지")
    @Test
